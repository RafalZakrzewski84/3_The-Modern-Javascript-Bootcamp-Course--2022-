...
const divByFive = nums.filter(n => n % 5 === 0);
...
// const authorQuery = 'Gold';
// const authorResults = books.filter(book => {
//     const author = book.authors.toLowerCase();
//     return author.includes(authorQuery.toLowerCase())
// })

const author = books.filter(book => (
    book.authors.includes('William Golding')
))